...
namespace MovieTicket.Application.DataTransferObjs.Film
{
    ...
    public class FilmUpdateRequest
    {
        ...
        [CustomValidation(typeof(FilmUpdateRequest), nameof(ValidateReleaseYear))]
        ...
        public static ValidationResult? ValidateReleaseYear(int? releaseYear, ValidationContext context)
        {
