...
namespace MovieTicket.API.Controllers
{
    ...
    public class AdminHomeController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult> GetListRevenueByCinemaAsync(DateTime? startDate, DateTime? endDate)
        {
        ...
        [HttpGet]
        public async Task<ActionResult> GetListRevenueByMovieAsync(DateTime? startDate, DateTime? endDate)
        {
