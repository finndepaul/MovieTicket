...
namespace MovieTicket.Infrastructure.Database.Configurations
{
    internal class ShowTimeConfiguration : IEntityTypeConfiguration<ShowTime>
    {
        public void Configure(EntityTypeBuilder<ShowTime> builder)
        {
            ...
            builder.HasOne(x => x.ScreenType).WithOne(x => x.ShowTime).HasForeignKey<ShowTime>(x => x.ScreenTypeId);
            ...
            builder.HasOne(x=>x.TranslationType).WithOne(x=>x.ShowTime).HasForeignKey<ShowTime>(x=>x.TranslationTypeId);
