    ...
    public class MovieTicketReadWriteDbContext : DbContext
    {
		...
		private void SeedingDataWithBogus(ModelBuilder modelBuilder)
		{
			...
			var accountFaker = new Faker<Account>()
				...
				.RuleFor(a => a.CreateDate, f => f.Date.Between(new DateTime(2023, 8, 1), new DateTime(2023, 8, 30)));
			...
			accounts.Insert(0, new Account
			{
				...
				CreateDate = new DateTime(2023, 8, 11)
			});
			...
			var filmFaker = new Faker<Film>()
				...
				.RuleFor(f => f.StartDate, f => f.Date.Between(new DateTime(2023, 1, 1), new DateTime(2023, 12, 31)))
				.RuleFor(f => f.ReleaseYear, 2023)
				...
				.RuleFor(f => f.CreatDate, f => f.Date.Between(new DateTime(2023, 8, 1), new DateTime(2023, 8, 30)));
			...
			var scheduleFaker = new Faker<Schedule>()
				...
				.RuleFor(s => s.StartDate, f => f.Date.Between(new DateTime(2023, 8, 1), new DateTime(2023, 8, 30)))
				.RuleFor(s => s.EndDate, f => f.Date.Between(new DateTime(2023, 8, 1), new DateTime(2023, 9, 30)))
			...
			var showTimeFaker = new Faker<ShowTime>()
				...
				.RuleFor(s => s.StartTime, f => f.Date.Future())
